  ...
  <div class="container cuerpo">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Quién soy</h5>
                <button
                  type="button"
                  class="btn-close"
    ...
    <div class="row fila-2">
      ...
      >
        ...
        <a
          title="Twitter"
          href="https://twitter.com/Nat_Array"
        >
        ...
        >
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas, nostrum cupiditate? Ut quisquam nostrum eos delectus? Deleniti iure porro nam enim, temporibus et earum blanditiis expedita, sed voluptatum, similique quas!</div>
      ...
      >
        ...
        >
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Otros intereses</h5>
                <button
                  type="button"
                  class="btn-close"
                  data-bs-dismiss="modal"
              ...
              <div class="modal-body">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem facere temporibus ut sequi rerum quam tempore! Quam dolor illo minus alias ducimus obcaecati rem optio praesentium ut soluta, architecto temporibus?</div>
